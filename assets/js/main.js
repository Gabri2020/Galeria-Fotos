...
// function idiomaespañol(e) {
// 	console.log("entro español");
// 	console.log(ingles);
// 	if (ingles = false) {
// 		console.log("previene cargar");
...
// function idiomaingles(e) {
// 	console.log("entro ingles");
// 	console.log(ingles);
// 	if (ingles = true) {
// 		console.log("previene cargar");
// 		e.preventDefault(); //Evita que la página actual vaya a la url del action
...
var main = (function($) { var _ = {
	...
	initEvents: function() {
		var preload = document.querySelector('.preload-contenedor');
		// Window.
